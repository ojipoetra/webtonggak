...
@section('dashboard')
    ...
    <div class="page-title">
        <a href="{{ url('/layanan') }}" class="btn btn-info mb-3">Kembali</a>
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                            ...
                            <form action="{{ route('layanan.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <input class="form-control @error('nama_layanan') is-invalid @enderror"
                                        name="nama_layanan" type="text" id="layanan" value="{{ old('nama_layanan') }}">
                                    @error('nama_layanan')
                                ...
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <input class="form-control @error('slug') is-invalid @enderror" name="slug"
                                        type="text" id="slug" value="{{ old('slug') }}">
                                    @error('slug')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <input class="form-control @error('gambar') is-invalid @enderror" name="gambar"
                                        type="file" id="gambar" value="{{ old('gambar') }}">
                                    @error('gambar')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <button type="submit" class="btn btn-success mt-2"><i
                                        class="bi bi-cloud-arrow-up-fill fs-5 text-light"></i> Upload</button>
                            </form>
                        </div>
                    </div>
                </div>
