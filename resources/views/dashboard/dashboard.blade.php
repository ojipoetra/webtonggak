...
@section('dashboard')
    ...
    <div class="page-title">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="row g-0">
                        <img src="{{ asset('icon/man.png') }}" class="img-fluid rounded-start" alt="..."
                            style="width: 6rem">
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="row g-0">
                        <img src="{{ asset('icon/woman.png') }}" class="img-fluid rounded-start" alt="..."
                            style="width: 6rem">
                        <div class="col-md-8">
                            <div class="card-body">
    ...
    <script>
        var options = {
            ...
            xaxis: {
                categories: ['Poli Anak', 'Poli Bedah', 'Poli Gigi', 'UGD', 'Poli Kandungan', 'Poli Umum',
                    'Poli Penyakit Dalam'
                ],
            },
            yaxis: {
